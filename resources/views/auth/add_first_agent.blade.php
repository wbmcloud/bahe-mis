...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="{{  route('user.doadd', ['type' => \App\Common\Constants::ADD_USER_TYPE_FIRST_AGENT]) }}">
        ...
        <div class="box-body">
            ...
            <button type="submit" id="add_first_agent_btn" class="btn btn-info pull-right">提交</button>
        </div>
    </form>
@endsection
...
<script type="text/javascript">
    ...
    $('#add_first_agent_btn').click(function () {
        $('#add_first_agent_btn').attr('disabled', 'true');
